                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('members.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="nama_pelanggan" name="nama_pelanggan" value="{{ old('nama_pelanggan') }}" required class="form-control @error('nama_pelanggan') is-invalid @enderror">
                        </div>

                        <div class="mb-3">
                            <label for="username" class="form-label">Username:</label>
                            <input type="text" id="username" name="username" value="{{ old('username') }}" required class="form-control @error('username') is-invalid @enderror">
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea id="alamat" name="alamat" required class="form-control @error('alamat') is-invalid @enderror" rows="3">{{ old('alamat') }}</textarea>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" id="poin_member" name="poin_member" value="{{ old('poin_member', 0) }}" min="0" class="form-control @error('poin_member') is-invalid @enderror">
                        </div>
